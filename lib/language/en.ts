  ...
  pages: {
    home: {
        ...
        items: [
          {
            ...
            desc: 'Multi-layer modular systems (Spine → Wrapper → Interface) enabling scalable infrastructure across professional verticals.',
          },
          {
            title: 'AI Orchestration',
            desc: 'Formal protocols for multi-AI coordination with defined roles, boundaries, and accountability structures.',
          },
          {
            title: 'Compliance-Aware Design',
            desc: 'Healthcare, legal, and financial regulatory navigation built into architecture, not bolted on after.',
          },
          {
            title: 'Execution Engineering',
            desc: 'PMO-grade orchestration frameworks with agent sequencing, phase gates, and mandatory verification.',
          },
          {
            title: 'Knowledge Architecture',
            desc: 'Semantic compression methodologies that extract reusable, citable knowledge units from raw operational data.',
          },
          {
            title: 'Multilingual Systems',
            desc: 'EN/FR/ES operational surfaces designed at the architecture level, not just the translation layer.',
          },
        ],
      },
      ...
      differentiators: {
        ...
        items: [
          {
            title: 'Systems-first, not features-first',
            desc: 'Solves structural problems, not surface symptoms.',
          },
          {
            title: 'Built-in governance',
            desc: 'Handles regulated environments without bolting on compliance later.',
          },
          {
            title: 'AI as architecture',
            desc: 'Not “uses AI” — designed formal protocols for multi-AI coordination.',
          },
          {
            title: 'Operational realism',
            desc: 'NOW/PILOT/FUTURE honesty. Mandatory demo gates. Anti-vaporware.',
          },
        ],
      },
