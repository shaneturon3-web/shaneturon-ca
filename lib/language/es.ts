  ...
  pages: {
    home: {
        ...
        items: [
          {
            ...
            desc: 'Sistemas modulares multicapa (Spine → Wrapper → Interface) que habilitan infraestructura escalable en verticales profesionales.',
          },
          {
            title: 'Orquestación de IA',
            desc: 'Protocolos formales para coordinación multi-IA con roles, límites y estructuras de responsabilidad definidos.',
          },
          {
            title: 'Diseño con Cumplimiento Integrado',
            desc: 'Navegación regulatoria en salud, legal y finanzas integrada en la arquitectura, no agregada después.',
          },
          {
            title: 'Ingeniería de Ejecución',
            desc: 'Frameworks de orquestación tipo PMO con secuenciación de agentes, phase gates y verificación obligatoria.',
          },
          {
            title: 'Arquitectura de Conocimiento',
            desc: 'Metodologías de compresión semántica que extraen unidades de conocimiento reutilizables y citables desde datos operacionales crudos.',
          },
          {
            title: 'Sistemas Multilingües',
            desc: 'Superficies operacionales EN/FR/ES diseñadas a nivel de arquitectura, no solo en la capa de traducción.',
          },
        ],
      },
      ...
      differentiators: {
        ...
        items: [
          {
            title: 'Primero sistemas, no primero funciones',
            desc: 'Resuelve problemas estructurales, no síntomas superficiales.',
          },
          {
            title: 'Gobernanza integrada',
            desc: 'Maneja entornos regulados sin agregar cumplimiento después.',
          },
          {
            title: 'IA como arquitectura',
            desc: 'No “usa IA”; diseña protocolos formales para coordinación multi-IA.',
          },
          {
            title: 'Realismo operacional',
            desc: 'Honestidad NOW/PILOT/FUTURE. Gates obligatorios de demo. Anti-vaporware.',
          },
        ],
      },
